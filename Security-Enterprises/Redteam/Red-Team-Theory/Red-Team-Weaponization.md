...
Follow the link to [[Introduction-To-Comand-And-Control-Frameworks]]. These framework contain all of the above and [[Useful-Csharp]] method from exploitation to exfiltration and for a listing of C2s see [[C2-Matrix]].
